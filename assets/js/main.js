...
document.querySelector("#app").innerHTML = `
  ...
  <main id="cards">
    ...
    ${createCard("23/11","quarta",createGame("morocco","0 x 0","croatia")+createGame("germany","1 x 2","japan")+createGame("spain","7 x 0","costa rica")+createGame("belgium","1 x 0","canada"))}
    ...
    ${createCard("27/11","domingo",createGame("japan","0 x 1","costa rica")+createGame("belgium","0 x 2","morocco")+createGame("croatia","4 x 1","canada")+createGame("spain","1 x 1","germany"))}
    ...
    ${createCard("29/11","terça",createGame("ecuador","1 x 2","senegal")+createGame("netherlands","2 x 0","qatar")+createGame("wales","0 x 3","england")+createGame("iran","0 x 1","united states"))}
    ${createCard("30/11","quarta",createGame("australia","1 x 0","denmark")+createGame("tunisia","1 x 0","france")+createGame("saudi arabia","1 x 2","mexico")+createGame("poland","0 x 2","argentina"))}
    ${createCard("01/12","quinta",createGame("canada","1 x 2","morocco")+createGame("croatia","0 x 0","belgium")+createGame("costa rica","2 x 4","germany")+createGame("japan","2 x 1","spain"))}
    ${createCard("02/12","sexta",createGame("south korea","2 x 1","portugal")+createGame("ghana","0 x 2","uruguay")+createGame("cameroon","1 x 0","brazil")+createGame("serbia","2 x 3","switzerland"))}
    ${createCard("03/12","sábado",createGame("netherlands","3 x 1","united states")+createGame("argentina","2 x 1","australia"))}
    ${createCard("04/12","domingo",createGame("france","3 x 1","poland")+createGame("england","3 x 0","senegal"))}
    ${createCard("05/12","segunda",createGame("japan","(1) x (3)","croatia")+createGame("brazil","4 x 1","south korea"))}
    ${createCard("06/12","terça",createGame("morocco","(3) x (0)","spain")+createGame("portugal","6 x 1","switzerland"))}
